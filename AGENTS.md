...
- [ ] 6. The connector — set MCP_TOKEN, `Codex mcp add …`         OPTIONAL
...
7. The honest **tokens** note (you run on their Codex tokens), then show it's
...
Then the video teases the NEXT episode: automated data, Vitals, scheduled Codex
...
- No AI keys in the app, ever. Intelligence runs here, in Codex; the app
