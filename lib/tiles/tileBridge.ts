...
(function () {
  ...
  // This dashboard is branded Pulse; alias so tiles written against
  // window.Pulse (same save/load contract) work alongside stock tiles
  // that speak window.Vitality directly.
  window.Pulse = window.Vitality;
})();
</script>`
